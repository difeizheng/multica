...
WHERE id = $1
RETURNING id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes
`
...
SELECT id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes FROM squad WHERE id = $1
`
...
SELECT s.id, s.workspace_id, s.name, s.description, s.leader_id, s.creator_id, s.created_at, s.updated_at, s.archived_at, s.archived_by, s.avatar_url, s.instructions, s.heartbeat_interval_minutes FROM squad s WHERE s.id = $1 AND s.workspace_id = $2
`
...
SELECT id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes FROM squad WHERE id = $1 AND workspace_id = $2
`
...
SELECT id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes FROM squad WHERE workspace_id = $1 ORDER BY created_at ASC
`
...
SELECT id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes FROM squad WHERE workspace_id = $1 AND archived_at IS NULL ORDER BY created_at ASC
`
...
SELECT s.id, s.workspace_id, s.name, s.description, s.leader_id, s.creator_id, s.created_at, s.updated_at, s.archived_at, s.archived_by, s.avatar_url, s.instructions, s.heartbeat_interval_minutes FROM squad s
...
UPDATE squad SET
    ...
    heartbeat_interval_minutes = COALESCE($7, heartbeat_interval_minutes),
    updated_at = now()
WHERE id = $1
RETURNING id, workspace_id, name, description, leader_id, creator_id, created_at, updated_at, archived_at, archived_by, avatar_url, instructions, heartbeat_interval_minutes
`
...
type UpdateSquadParams struct {
	...
	HeartbeatIntervalMinutes pgtype.Int4 `json:"heartbeat_interval_minutes"`
}
